...
exports.HTTPComms.prototype =
{
    init : function( as, ctx )
    {
        ...
        var optcb = ctx.options[ "COMM_CONFIG_CB" ];
    ...
    perform : function( as, ctx, req )
    {
        ...
        if ( rawreq )
        {
            ...
            {
                as.error( invoker.FutoInError.InvokerError, "Please set 'length' property even for stream.Readable" );
            }
        ...
        var req = opts.http_impl.request( opts );
        ...
        {
            as.error( invoker.FutoInError.CommError, "Low error: " + e.message );
        } );
...
exports.WSComms.prototype =
{
    init : function( as, ctx )
    {
        ...
        ws = new ws.WebSocket( ctx.info.endpoint, opts );
        this.ws = ws;
        ...
        var cleanup = function( arg1, arg2 ) {
            ...
            for ( var k in reqas )
            {
                reqas[ k ].error( invoker.FutoInError.CommError, arg2 ? "Cleanup" : "Error" );
            }
