        ...
        switch ( type )
        {
            ...
            case 'integer':
                if ( typeof val !== "number" ||
                     ( ( val | 0 ) !== 0 ) )
                {
                    as.error( FutoInError.InvalidRequest, "Type mismatch for parameter" );
                }
...
AdvancedCCMImpl.prototype =
{
    ...
    onDataResponse : function( as, ctx, rsp )
    {
        ...
        {
            throw new Error( FutoInError.InternalError, "Raw result is not expected" );
        }
    }
};

_.extend( AdvancedCCMImpl.prototype, simpleccm_impl.SimpleCCMImpl.prototype );
