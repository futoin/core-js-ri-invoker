...
const FUTOIN_CONTENT_TYPE = optname.FUTOIN_CONTENT_TYPE;
...
exports.HTTPComms = class
{
    ...
    _perform( as, ctx, req )
    {
        ...
        else
        {
            ...
            const byte_length = Buffer.byteLength( rawreq, 'utf8' );
...
exports.WSComms = class WSComms
{
        ...
        if ( this._waiting_open )
        {
            as
                .add( ( as ) =>
                {
                    ...
                    as.setCancel( () =>
                    {
                        this.ws.removeListener( 'open', on_open );
                    } );
                } );
        }
    ...
    _perform( as, ctx, req )
    {
        ...
        //
        const rawmsg = JSON.stringify( req );
