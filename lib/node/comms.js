...
var process_ver = process.version.split( '.' );
var AgentKeepAlive;
var AgentKeepAliveSecure;

if ( process_ver[0] > 'v0' || parseInt( process_ver[ 1 ] ) >= 11 )
{
    AgentKeepAlive = require( 'agentkeepalive' );
    AgentKeepAliveSecure = AgentKeepAlive.HttpsAgent;
}
else
{
    AgentKeepAlive = require( 'keep-alive-agent' );
    AgentKeepAliveSecure = AgentKeepAlive.Secure;
}
