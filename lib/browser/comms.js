...
const MyWebSocket = WebSocket; // jshint ignore:line
const FUTOIN_CONTENT_TYPE = common.Options.FUTOIN_CONTENT_TYPE;
    ...
    _perform( as, ctx, req ) {
        ...
        if ( ctx.expect_response ) {
            ...
            httpreq.onreadystatechange = function() {
                ...
                const response = ctx.download_stream ?
                    this.response :
                    this.responseText;
...
class WSComms {
    ...
    init( as, ctx ) {
        ...
        const send_executor_rsp = ( rsp ) => {
            const rawrsp = executor.packPayloadJSON( rsp );
...
class BrowserComms {
    ...
    init( as, ctx ) {
        ...
        const browser_window = window; // jshint ignore:line
        let iframe;
        ...
        if ( target === 'parent' ) {
            ...
            const browser_document = document; // jshint ignore:line
